...
const PlusIcon = () => <Text style={{ fontSize: 16, color: 'inherit' }}>+</Text>;
const ArrowIcon = () => <Text style={{ fontSize: 16, color: 'inherit' }}>→</Text>;
const HeartIcon = () => <Text style={{ fontSize: 16, color: 'inherit' }}>♥</Text>;
