/**
 * Styling System Example Screen - Simple Version Tests
 * Tests the simplified example screen functionality
 */

import React from 'react';
import { render, fireEvent, waitFor } from '@testing-library/react-native';
import { Alert } from 'react-native';
import StylingSystemExampleSimple from '../styling-system-example-simple';
...
const renderWithTheme = (initialTheme = 'light') => {
  return render(
    <ThemeProvider initialTheme={initialTheme}>
      <StylingSystemExampleSimple />
    </ThemeProvider>
  );
};

describe('StylingSystemExampleSimple', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
